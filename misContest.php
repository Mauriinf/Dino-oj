...
<div align="center">
    ...
    $consulta2 = "SELECT count(*) as total_registro from contest 
                                WHERE  (Titulo LIKE '%$busqueda%' or contest_id LIKE '%$busqueda%')
                                AND Owner='".$_SESSION["UserName"]."'";//cambiar a SI
    ...
    $consulta = "SELECT * from contest 
                                WHERE  (Titulo LIKE '%$busqueda%' or contest_id LIKE '%$busqueda%')
                                AND Owner='".$_SESSION["UserName"]."'";

    //ordenar los concursos segun titulo  estado y corriendo
     if(isset($_GET["orden"])){
    ...
    <div class="cabezera">
    <div class="divuno">
    <form action="misContest.php" method="post">
    ...
    <thead> <tr >
        ...
        <th width='25%'><a href="misContest.php?orden=Titulo">Titulo</a></th> 
        <th width='12%'><a href="misContest.php?orden=Inicio">Inicio</a></th> 
        <th width='12%'><a href="misContest.php?orden=Final">Fin</a></th> 
        <th width='12%'><a >Estado</a></th> 
        <th width='12%'><a href="misContest.php?orden=EsPrivado">Privado</a></th> 
    ...
    $left = 0;
       ...
       echo "<TD align='center' >". $row['contest_id'] ."</TD>";
        ...
        echo "<TD align='center' style='color:#3A8935';>". $row['Final']   ." </TD>";
        $estado="";
        $color=0;
        ...
        if($color==1){
         ...
         echo "<TD align='center' style='color:#0F8BF2';>";
            echo '<a   href="editarContest.php?id='.$row['contest_id'].'"><img src="img/edit.ico" width="32px" height="32px" /></a>';
            echo '&nbsp;';
            echo '<a   href="eliminarContest.php?id='.$row['contest_id'].'"><img src="img/delete.ico" width="32px" height="32px" /></a>';
         echo " </TD>";
        echo "</TR>";
        $left++;
    }
...
?>
<div><br><br><br></div>
<div align='center'><h3>Debes iniciar sesi&oacute;n.</h3></div> 
<?php 
}
?>
