...
function enviando(){
		...
		mysqli_query ( "INSERT INTO Ejecucion (`userID` , `probID` , `remoteIP`, `Concurso`) VALUES ('{$usuario}', {$prob}, '" . $_SERVER['REMOTE_ADDR']. "', " . $_REQUEST['cid'] . "); " ) or die('Algo anda mal: ' . mysql_error());
		$resultado = mysqli_query ($enlace, "SELECT `execID` FROM `Ejecucion` order by `fecha` desc limit 1;" ) or die('Algo anda mal: ' . mysql_error());
		$row = mysqli_fetch_array ( $resultado );
...
<div class="wrapper">
	...
	?>	
		<div class="post" style="background:white;">	
			...
			?>
				<form id="frm" name="concurso" action="contest_rank.php?cid=<?php echo $CONTEST?>" method="post" enctype="multipart/form-data">
						...
						function showProblem(){
							...
							$("#problem_div").fadeOut("fast", function (){
								...
								{	
									...
									html +=  "<TD align='center' ><a target='_blank' href='verProblema.php?id=" +CurrentPoblem[a].pid+"&cid="+<?php echo $CONTEST; ?>+"'>" +CurrentPoblem[a].titulo+"</a> </TD>";
					...
					$("#runs_div").fadeOut("fast", function (){
						...
						{	
							...
							switch(CurrentRuns[a].Estado){
								...
								case "0":
									CurrentRuns[a].Estado = "<span style='color:purple;'>Pending</span>";
								break;
								case "1":
									CurrentRuns[a].Estado = "<span style='color:purple;'>Pending Rejudge</span>";
								break;
								case "2":
									CurrentRuns[a].Estado = "<span style='color:red;'>Compiling</span>";
								break;
								case "3":
									CurrentRuns[a].Estado = "<span style='color:purple;'>Judging...</span>";	//<img src='img/load.gif'>
								break;
								//case "Running":
								//	CurrentRuns[a].Estado = "<span style='color:purple;'>" + CurrentRuns[a].Estado + "...</span>";	//<img src='img/load.gif'>
								//break;
								case "4":
									CurrentRuns[a].Estado = "<span style='color:green;'><b>Accepted</b></span>";
								break;
								case "5":
									CurrentRuns[a].Estado = "<span style='color:brown;'><b>Presentation Error</b></span>";
								break;
								case "6":
									CurrentRuns[a].Estado = "<span style='color:red;'><b>Wrong Answer</b></span>";				
								break;
								case "7": 
									CurrentRuns[a].Estado = "<span style='color:brown;'>Time Limit Exceeded</span>";
								break;
								case "8":
									CurrentRuns[a].Estado = "<span style='color:brown;'><b>Memory Limit Exceeded</b></span>";
								break;								
								case "9":
									CurrentRuns[a].Estado = "<span style='color:red;'><b>Output Limit Exceeded</b></span>";				
								break;
								case "10":
									CurrentRuns[a].Estado = "<span style='color:blue;'><b>Runtime Error</b></span>";				
								break;							
								case "11":
									CurrentRuns[a].Estado = "<span style='color:red;'><b>Compile Error</b></span>";				
								break;
																
							}
							switch(CurrentRuns[a].Lenguaje){

								
								case "0":
									CurrentRuns[a].Lenguaje = "<span style='color:purple;'>C</span>";
								break;
								case "1":
									CurrentRuns[a].Lenguaje = "<span style='color:purple;'>C++</span>";
								break;
								case "2":
									CurrentRuns[a].Lenguaje = "<span style='color:red;'>Pas</span>";
								break;
								case "3":
									CurrentRuns[a].Lenguaje = "<span style='color:purple;'>Java</span>";	//<img src='img/load.gif'>
								break;
								case "4":
									CurrentRuns[a].Lenguaje = "<span style='color:green;'><b>rb</b></span>";
								break;
								case "5":
									CurrentRuns[a].Lenguaje = "<span style='color:brown;'><b>sh</b></span>";
								break;
								case "6":
									CurrentRuns[a].Lenguaje = "<span style='color:red;'><b>py</b></span>";				
								break;
								case "7": 
									CurrentRuns[a].Lenguaje = "<span style='color:brown;'>php</span>";
								break;
								case "8":
									CurrentRuns[a].Lenguaje = "<span style='color:brown;'><b>pl</b></span>";
								break;								
								case "9":
									CurrentRuns[a].Lenguaje = "<span style='color:red;'><b>cs</b></span>";				
								break;
								case "10":
									CurrentRuns[a].Lenguaje = "<span style='color:blue;'><b>m</b></span>";				
								break;							
								case "11":
									CurrentRuns[a].Lenguaje = "<span style='color:red;'><b>bas</b></span>";				
								break;
								case "12":
									CurrentRuns[a].Lenguaje = "<span style='color:red;'><b>scm</b></span>";				
								break;
								case "13":
									CurrentRuns[a].Lenguaje = "<span style='color:red;'><b>C</b></span>";				
								break;
								case "14":
									CurrentRuns[a].Lenguaje = "<span style='color:red;'><b>CC</b></span>";				
								break;
								case "15":
									CurrentRuns[a].Lenguaje = "<span style='color:red;'><b>py</b></span>";				
								break;
