...
require_once("bootstrap.php");
	...
	if ( !empty($_POST))
	{
		...
		{			
			...
			if($registro > 0)
			{	
				$arch = "/home/judge/data/".$registro.$tipo;//almacena en $nom la fecha hora segundo y milesegundo en la q se subio el archivo
				
				copy($_FILES['archivo']['tmp_name'], $arch);
				$carpeta = "/home/judge/data/".$registro;
...
<div class="wrapper">
	...
	<div class="post" style="background:white;">
		...
		<form action="crearProblema.php" method="post" enctype="multipart/form-data">
			...
			<textarea id="editor2" row="10" cols="5" name="entrada" ></textarea>
			<div id="checkeditor2" class=""></div>
			<label for="salida">
				Salida
			</label>
			<textarea id="editor3" row="10" cols="5" name="salida" ></textarea>
			<div id="checkeditor3" class=""></div>
...
if(editor2==""){
  		$("#checkeditor2").html("<div class='alert alert-danger'>Llene el campo!<input value='error' type='hidden' name='passwordchecker'></div>");
  		document.getElementById("submitBoton").disabled = true; 
  	}else{
	  	if(editor2.length < 4){
			$("#checkeditor2").html("<div class='alert alert-danger'> Entrada muy corta.<input value='error' type='hidden' name='passwordchecker'></div>");
	  		document.getElementById("submitBoton").disabled = true; 
	  	}else{	  		  			 
				$("#checkeditor2").html("<div class='alert alert-success'> Correcto.<input value='error' type='hidden' name='passwordchecker'></div>");
		  		document.getElementById("submitBoton").disabled = false;
	  	}	  		  			 
...
if(editor3==""){
  		$("#checkeditor3").html("<div class='alert alert-danger'>Llene el campo!<input value='error' type='hidden' name='passwordchecker'></div>");
  		document.getElementById("submitBoton").disabled = true; 
  	}else{
	  	if(editor3.length < 4){
			$("#checkeditor3").html("<div class='alert alert-danger'> Salida muy corta.<input value='error' type='hidden' name='passwordchecker'></div>");
	  		document.getElementById("submitBoton").disabled = true; 
	  	}else{	  		  			 
				$("#checkeditor3").html("<div class='alert alert-success'> Correcto.<input value='error' type='hidden' name='passwordchecker'></div>");
		  		document.getElementById("submitBoton").disabled = false;
	  	}	  		  			 
